  ...
  return (
    <>
      ...
      <div className="p-8 max-w-md mx-auto">
        ...
        <div className="mb-8 p-4 border rounded-3xl bg-gray-900">
          ...
          <form className="space-y-3" onSubmit={handleAdminUpdate}>
            <div>
              ...
              <input type="text" value={user.username} readOnly className="w-full px-3 py-2 border rounded-3xl bg-gray-900" />
            </div>
            <div>
